...
const navLinks = [
  { to: '/dashboard/inge/sessions-a-confirmer', label: 'Sessions à confirmer' },
  { to: '/dashboard/inge/sessions', label: 'Sessions à venir' },
...
<template>
  <section class="space-y-6">
    ...
    >
      <div>
        <h1 class="pds-h2 text-xl">Tableau de bord – Ingé son</h1>
